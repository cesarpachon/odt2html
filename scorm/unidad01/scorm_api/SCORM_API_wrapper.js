...
pipwerks.SCORM.API.find = function(win){
    ...
    var API = null,
		...
		//CESAR
		//alert("cesar finding api: attempt:"+findAttempts+" win:"+win+" win.parent:"+win.parent);
...
pipwerks.SCORM.connection.initialize = function(){
    ...
    if(!scorm.connection.isActive){
		...
		trace("connection.initialize: I have the handle, scorm.version is "+ scorm.version);
               
			switch(scorm.version){
				case "1.2" : 
					success_text = API.LMSInitialize("");
					success = makeBoolean(success_text); 
					if(!success)
					{
						trace(traceMsgPrefix +" failed: success_text: " + success_text);
					}
					break;
